...
Sidebar.Material = function ( editor ) {
	...
	materialSpecularRow.add( new UI.Text( '镜面高光' ).setWidth( '90px' ) );
	...
	materialShininessRow.add( new UI.Text( '光亮程度' ).setWidth( '90px' ) );
	...
	materialAlphaMapRow.add( new UI.Text( '阿尔法贴图' ).setWidth( '90px' ) );
	...
	materialDisplacementMapRow.add( new UI.Text( '移位映射' ).setWidth( '90px' ) );
	...
	materialRoughnessMapRow.add( new UI.Text( '粗糙的贴图' ).setWidth( '90px' ) );
	...
	materialEnvMapRow.add( new UI.Text( '电子贴图' ).setWidth( '90px' ) );
	...
	materialLightMapRow.add( new UI.Text( '光照贴图' ).setWidth( '90px' ) );
	...
	materialAOMapRow.add( new UI.Text( 'AO 贴图' ).setWidth( '90px' ) );
	...
	materialEmissiveMapRow.add( new UI.Text( '自发光贴图' ).setWidth( '90px' ) );
	...
	materialShadingRow.add( new UI.Text( '平阴影' ).setWidth( '90px' ) );
	...
	materialOpacityRow.add( new UI.Text( '不透明性' ).setWidth( '90px' ) );
	...
	materialTransparentRow.add( new UI.Text( '透明的' ).setWidth( '90px' ) );
	...
	materialAlphaTestRow.add( new UI.Text( '阿尔法测验' ).setWidth( '90px' ) );
