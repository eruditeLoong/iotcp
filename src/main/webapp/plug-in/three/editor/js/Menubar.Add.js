...
Menubar.Add = function ( editor ) {
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( '圆圈（Circle）' );
	option.onClick( function () {
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( '二十面体（Icosahedron）' );
	option.onClick( function () {
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( '环面（Torus）' );
	option.onClick( function () {
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( '环形结（TorusKnot）' );
	option.onClick( function () {
	...
	*/
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( '车床（Lathe）' );
	option.onClick( function() {
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( '平行光（DirectionalLight）' );
	option.onClick( function () {
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( '半球形光源（HemisphereLight）' );
	option.onClick( function () {
