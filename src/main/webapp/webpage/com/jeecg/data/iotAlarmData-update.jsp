			...
			<div class="row">
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="dataValue" type="text" class="form-control input-sm" maxlength="32" value="${iotAlarmData.dataValue}" datatype="*" ignore="checked"/>
						</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<t:dictSelect field="alarmLevel" defaultVal="${iotAlarmData.alarmLevel}" type="select" hasLabel="false" title="报警级别" extendJson="{class:'form-control'}" datatype="n"
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="alarmDate" type="text" class="form-control input-sm laydate-datetime"
