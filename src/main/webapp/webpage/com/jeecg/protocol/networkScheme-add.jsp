	...
	<div class="container" style="padding: 20px;">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" id="formobj" action="networkSchemeController.do?doAdd" method="POST">
						...
						<div class="form-group">
							...
							<div class="bt-item col-md-6 col-sm-6">
								<div class="row">
									...
									<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
										<input id="createDate" name="createDate" value='<fmt:formatDate value='${networkScheme.createDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>' type="text"
						...
						<div class="form-group">
							<div class="bt-item col-md-6 col-sm-6">
								<div class="row">
									...
									<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
										<input id="sysOrgName" value='${fns:getDepartnameByOrgcode(networkScheme.sysOrgCode) }' type="text" readonly="readonly" class="form-control input-sm" />
									</div>
								</div>
							</div>
							<div class="bt-item col-md-6 col-sm-6">
								<div class="row">
									...
									<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
										<input value="${fns:getDepartnameByOrgcode(networkScheme.sysCompanyCode)}" type="text" class="form-control input-sm" readonly="readonly" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<div class="input-group" style="width: 100%">
									<input id="name" name="name" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入方案名称" datatype="*" ignore="checked" />
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-7">
								<div class="input-group" style="width: 100%">
									<span class="input-group-btn">
										<button class="btn btn-info input-sm" type="button"><span class="fa fa-hand-o-right"></span></button>
									</span>
									<t:dictSelect field="connectionModeBy" type="list" extendJson="{class:'form-control input-sm'}" datatype="*" dictTable="jform_connection_mode" dictField="code"
										dictText="name" hasLabel="false" title="接入模式"></t:dictSelect>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-7">
								<div class="input-group" style="width: 100%">
									...
									<t:dictSelect field="netModeBy" type="list" extendJson="{class:'form-control input-sm'}" datatype="*" dictTable="jform_net_mode" dictField="code" dictText="name"
										hasLabel="false" title="通讯方式"></t:dictSelect>
								</div>
							</div>
						</div>
						<div class="form-group">
