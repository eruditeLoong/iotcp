	...
	<div class="container" style="width: 100%; overflow-x: hidden">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" id="formobj" action="comProtocolController.do?doAdd" method="POST">
					...
					<fieldset>
						...
						<div class="main-form">
							<div class="row">
								...
								<div class="bt-item col-md-6 col-sm-6">
									<div class="row">
										<div class="col-md-3 col-sm-3 col-xs-3 bt-label">协议编码：</div>
										<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
											<input name="code" type="text" class="form-control input-sm" maxlength="32" validType="jform_com_protocol,code,id" datatype="*" ignore="checked" />
										</div>
									</div>
								</div>
								<div class="bt-item col-md-6 col-sm-6">
									<div class="row">
										...
										<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
											<t:dictSelect field="checkType" type="select" hasLabel="false" title="校验类型" extendJson="{class:'form-control input-sm'}" datatype="*" dictTable="jform_com_check"
												dictField="code" dictText="name"></t:dictSelect>
										</div>
									</div>
								</div>
								<div class="bt-item col-md-6 col-sm-6">
									<div class="row">
										...
										<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
											<div style="padding-top: 5px">
												<t:dictSelect field="dataMode" extendJson="{class:'i-checks'}" type="radio" hasLabel="false" title="数据模式" typeGroupCode="data_mode"></t:dictSelect>
											</div>
										</div>
									</div>
								</div>
