...
<div class="container" style="width: 100%;">
	...
	<div class="panel-body">
		<form class="form-horizontal" role="form" id="formobj" action="sceneDeviceDepolyController.do?doAdd" method="POST">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group" style="width: 100%">
						<select id="deviceBy" name="deviceBy" class="form-control input-sm"></select>
					</div>
				</div>
			</div>
			<div class="form-group" style="">
				<label for="deviceBy" class="col-sm-3 control-label">父级设备：</label>
				<div class="col-sm-7">
					<div class="input-group" style="width: 100%">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group" style="width: 100%">
						<input id="deviceCode" name="deviceCode" type="text" maxlength="10" class="form-control input-sm" placeholder="请输入设备编码" datatype="*" ignore="checked"/>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group" style="width: 100%">
						<input id="deviceAddress" name="deviceAddress" type="text" maxlength="15" readonly="readonly" class="form-control input-sm" placeholder="请输入网关设备IP地址" datatype="*"
							   ignore="ignore"/>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group" style="width: 100%">
						<t:dictSelect id="isSendCmd" field="isSendCmd" type="radio" hasLabel="false" title="" extendJson="{class:'i-checks'}" datatype="*"
									defaultVal="N" typeGroupCode="sf_yn"></t:dictSelect>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-7">
					<t:dictSelect id="cmdDataType" field="cmdDataType" hasLabel="false" extendJson="{class:'form-control input-sm'}" type="select" defaultVal="string" typeGroupCode="dataShape"></t:dictSelect>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group" style="width: 100%">
						<input id="requestCmd" name="requestCmd" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入请求命令" datatype="*" ignore="ignore"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group" style="width: 100%">
						<input id="threeData" name="threeData" type="text" maxlength="200" class="form-control input-sm"
							   value='{"s":"1.00","rx":"0.00","ry":"0.00","rz":"0.00","x":"0.00","y":"0.00","z":"0.00"}' placeholder="请输入设备位置" datatype="*" ignore="checked"/>
					</div>
				</div>
			</div>
		</form>
