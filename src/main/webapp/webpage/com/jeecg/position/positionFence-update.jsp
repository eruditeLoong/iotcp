...
<form class="form-horizontal" role="form" id="formobj" action="positionFenceController.do?doUpdate" method="POST">
	<input type="hidden" id="btn_sub" class="btn_sub"/>
	<input type="hidden" id="id" name="id" value="${positionFencePage.id}"/>
	<fieldset>
		<legend>围栏信息</legend>
		<div class="main-form">
			<div class="row">
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<t:dictSelect id="isSceneBoundary" field="isSceneBoundary" defaultVal = "${positionFencePage.isSceneBoundary}" extendJson="{class:'i-checks'}" type="radio" hasLabel="false"  title="是否场景边界"  typeGroupCode="isBound" ></t:dictSelect>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-tb-toolbar">
	   		...
	   		<table class="table subinfo-table" id="potionFencePoint_table">
				...
				<tr>
					...
					<td>
							<input id="potionFencePointList[${stuts.index }].point" name="potionFencePointList[${stuts.index }].point" value = "${poVal.point}" type="text" class="form-control input-sm" maxlength="128"  datatype="*"  ignore="checked"  />
					</td>
					<td>
							<input id="potionFencePointList[${stuts.index }].sort" name="potionFencePointList[${stuts.index }].sort" value = "${poVal.sort}" type="text" class="form-control input-sm" maxlength="128"  datatype="n"  ignore="ignore"  />
					</td>
			  	</tr>
				</c:forEach>
				</c:if>
				...
				<tr>
					...
					<td>
							<input id="potionFencePointList[0].point" name="potionFencePointList[0].point"  type="text" class="form-control input-sm" maxlength="128"  datatype="*"  ignore="checked"  />
					</td>
					<td>
							<input id="potionFencePointList[0].sort" name="potionFencePointList[0].sort"  type="text" class="form-control input-sm" maxlength="128"  datatype="n"  ignore="ignore"  />
					</td>
			  	</tr>
				</c:if>
			 	</tbody>
