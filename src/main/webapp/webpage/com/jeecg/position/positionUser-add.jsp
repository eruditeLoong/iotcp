...
<div class="container" style="width:100%;">
    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" id="formobj" action="positionUserController.do?doAdd" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group" style="width:100%">
                        ...
                        <input type="text" class="form-control" id="imeiimei" name="imei">
                        ...
                        <script type="text/javascript">
                                ...
                                success: function (result) {
                                    if (result.obj.length > 0) {
                                        ...
                                        for (var i = 0; i < data.length; i++) {
                                            imeiList.value.push({
                                                'id': data[i].id,
                                                'electricity': data[i].electricity || 0,
                                            });
                                        }
                                        return imeiList;
                                    }
                            ...
                            var testBsSuggest = $("#imeiimei").bsSuggest({
                                showBtn: true,
                                ...
                                document.getElementById('imeiimei').value = keyword.id;
                            });
                        </script>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group" style="width:100%">
                        <input id="name" name="name" type="text" maxlength="32" autocomplete="off"
                               class="form-control input-sm" placeholder="请输入姓名" datatype="*"
                               ignore="checked"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group" style="width:100%">
                        <t:dictSelect field="useObject" type="list" extendJson="{class:'form-control input-sm'}" datatype="*"
                                      typeGroupCode="pUseObj"
                                      hasLabel="false" title="使用对象"></t:dictSelect>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group" style="width:100%">
                        <input id="telephone" name="telephone" type="text" maxlength="15" autocomplete="off"
                               class="form-control input-sm" placeholder="请输入电话" datatype="m"
                               ignore="ignore"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group" style="width:100%">
                        <input id="age" name="age" type="text" maxlength="2" class="form-control input-sm"
                               autocomplete="off" placeholder="请输入年龄" datatype="n" ignore="ignore"/>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <t:dictSelect id="status" field="status" defaultVal = "1" extendJson="{class:'i-checks'}" type="radio" hasLabel="false"  title="状态"  typeGroupCode="isValid" ></t:dictSelect>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group" style="width:100%">
                        <textarea name="remark" value="${positionUser.remark}" class="form-control input-sm" rows="6"
