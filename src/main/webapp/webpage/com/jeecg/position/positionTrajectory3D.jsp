...
<div id="userInfoDialog">
	<div style="width: 100%; height: 100%;">
		<div id="">
			<i class="fa fa-close" id="dialogTitle" style="text-align: center;">人员：</i>
...
<script type="text/javascript">
	...
	function viewIotData(type, id) {
		...
		layer.open({
			...
			closeBtn: 0,
			shadeClose: true,
			content: ['positionUserController.do?goUpdate&load=detail&id=' + id, 'no']
		});
	}
