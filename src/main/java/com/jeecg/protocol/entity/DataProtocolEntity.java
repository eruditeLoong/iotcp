 ...
 */
@Entity
@Table(name = "jform_data_protocol", schema = "")
@SuppressWarnings("serial")
public class DataProtocolEntity implements java.io.Serializable {
	/**主键*/
	...
	/**类型*/
	@Excel(name="类型",width=15,dicCode="dataProType")
	private java.lang.String type;
	/**数据形式*/
	@Excel(name="数据形式",width=15,dicCode="dataShape")
	...
	@Column(name ="DATA_SHAPE",nullable=false,length=32)
